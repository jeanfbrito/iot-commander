...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { data: @reading.data, device_id: @reading.device_id, timestamp: @reading.timestamp } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { data: @reading.data, device_id: @reading.device_id, timestamp: @reading.timestamp } }
